...
1. **Name the constraint** (2 min) — "What is our constraint right now?"
   Say it in one sentence. Has it shifted since last week?

2. **Throughput check** (3 min) — Look at 3-5 numbers: new trials,
   activations, deals closed, revenue, churn. What moved? What didn't?
   Review any 5-minute canvases from the week. Do the JTBD forces match
   your constraint diagnosis?
...
4. **Three priorities** (3 min) — Top 3 for the week, ranked by
   constraint impact. Name one thing you're explicitly NOT doing. Done.
