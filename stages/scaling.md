...
For teams of 5+. Same four phases as the growth review, expanded.

**Prep:** Generate a Customer Factory Funnel diagram with current numbers.
See `references/weekly-diagrams.md` for the template.
...
- "Is there a policy constraint sitting above the funnel step?"
- Reference the funnel diagram.

**Phase 2 — Throughput check (5 min)**
- Review the 3-5 metrics that matter. "What moved? What didn't? Why?"
- Review any 5-minute canvases from the week. Do the JTBD forces match
  the constraint diagnosis?

**Phase 3 — Buffer and flow (10 min)**
- "Is the constraint fed? Does the person/process at the bottleneck
  have everything they need?"
- "Where is work piling up?"
- Traffic light for active initiatives:
  - Green: On track — buffer healthy.
  - Yellow: At risk — buffer draining. Make a recovery plan.
  - Red: Behind — redirect non-constraint capacity to help.
- For multi-quarter initiatives: "What % done? What % of buffer consumed?"
...
- If constraint shifted: update team assignments, board, and GOLEAN goal
  in this meeting.
