...
### Essential reading (in order for a busy founder)
- **Bob Moesta & Greg Engle, *Demand-Side Sales 101* (2020)** — Most
  practical, shortest JTBD book. How people buy.
- **Alan Klement, *When Coffee and Kale Compete* (2018)** — Deep JTBD
  theory. Free at jtbd.info.
- **April Dunford, *Obviously Awesome* (2019)** — Positioning framework
  that operationalizes JTBD insights.
- **Clayton Christensen, *Competing Against Luck* (2016)** — The canonical
  JTBD book with the full milkshake story.
- **Clayton Christensen, *The Innovator's Dilemma* (1997)** — The
  foundation. Why great companies fail by serving existing customers too
  well while missing disruptive jobs-to-be-done.
- **Tony Ulwick, *Jobs to be Done: Theory to Practice* (2016)** — The
  quantitative ODI methodology.
- **Ash Maurya, *Running Lean* (3rd ed., 2022)** — The Lean Canvas and
  the specific questions to ask before building. Complements JTBD by
  stress-testing the business model around the job.

### Deeper dives
- **Bob Moesta, *Learning to Build* (2022)** — Developing JTBD across
  3,500+ products.
- **Intercom, *Intercom on Jobs-to-be-Done*** — Free ebook. Best resource
  for applying JTBD to software.

### Free templates and tools
- **Ash Maurya's Customer Forces Canvas V4** — Free PDF from Leanstack.
- **Strategyn's Job Map Worksheet** — Free fillable PDF at strategyn.com.
- **Brian Rhea's JTBD Resource Library** — Forces of Progress Interview
  Template at brianrhea.com.
